...
test.describe('Metronome', () => {
  test('controls tempo, meter, sound, and click volume', async ({ authenticatedPage: page }) => {
    ...
    await expect(page.getByTestId('metronome-bpm')).toHaveText('80')
    ...
    await expect(page.getByTestId('metronome-bpm')).toHaveText('92')
    await page.getByTestId('strumming-practice-level').selectOption('easy')
    await expect(page.getByTestId('metronome-bpm')).toHaveText('72')
    await page.getByTestId('strumming-practice-level').selectOption('hard')
    await expect(page.getByTestId('metronome-bpm')).toHaveText('112')
    await page.getByTestId('strumming-practice-level').selectOption('medium')
    await expect(page.getByTestId('metronome-bpm')).toHaveText('92')
    ...
    await expect(page.getByTestId('strumming-exercise-tempo')).toHaveText('medium · 96 BPM')
