...
LocalStorage is used in dev (no AWS dependency). S3Storage is used in prod
with auto-create bucket on startup.
"""
...
from inference_demucs.config import Settings
...
class StorageBackend(Protocol):
    ...
    def store_outputs(self, local_output_dir: str, output_name: str) -> str:
        """Store all files from local_output_dir to the backend. Returns output path/prefix."""
        ...
...
class LocalStorage:
    ...
    def store_outputs(self, local_output_dir: str, output_name: str) -> str:
        dest = self._base_path / output_name
